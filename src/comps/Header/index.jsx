...
const Header = () => {
    ...
    //functions needed for scrolling and menus
    ...
    return (
        <>
            ...
            <div className=''>
                <div>
                    <nav className={`h-[100px] w-full ${sticked ? 'sticked' : 'absolute z-100'} `}>
                        <div className={`max-w-screen-xl flex flex-wrap items-center justify-between mx-auto mt-[-8px] px-[15px]`}>
                            <a href="#" className="flex items-center my-2 space-x-3 rtl:space-x-reverse">
                            ...
                            <div className={`mt-[11px]`}>
                                <button data-collapse-toggle="navbar-default" ref={burgerRef} type="button" className={`${toggled ? "hambr" : ''} flex flex-col justify-center transition-all text-sm text-gray-500 rounded-lg h-10 w-10 hover:bg-gray-100 hover:bg-gray-700`} aria-controls="navbar-default" aria-expanded={sticked ? "true" : "true"} id="burger" onClick={toggleMenu}>
                                    <span className="mb-1 bar"></span>
                                    <span className="bar"></span>
                                    <span className="bar mt-[4px]"></span>
                                </button>
                            </div>
                            <div className="hidden w-auto md:block" id="navbar-default" ref={navbarRef}>
                                <ul ref={menu} className="gap-x-[-1px] mx-0 sm2:gap-x-[16.5px] font-medium flex flex-col p-3 pt-0 pb-1 md:p-0 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 mt-3 mb-[7px] ">
                                    <li className="flex ">
                                        <a href="#" className="block px-2 py-2 font-bold text-white no-underline under md2:text-lg" aria-current="page">Home</a>
                                    </li>
                                    <li className="flex">
                                        <a href="#recap" className="block px-2 py-2 font-bold text-white no-underline under md2:text-lg">Past Hacks</a>
                                    </li>
                                    <li className="flex">
                                        <a href="#sponsors" className="block px-2 py-2 font-bold text-white no-underline under md2:text-lg">Sponsors</a>
                                    </li>
                                    <li className="flex">
                                        <a href="https://boost-hacks-ii.devpost.com/#judges" target="_blank" className="block px-2 py-2 font-bold text-white no-underline under md2:text-lg">Judges</a>
                                    </li>
                                    <li className="flex">
                    ...
                    <div className={`absolute body mx-auto mt-12`}>
                        <p className='block p-0 mt-20 text-center align-middle'>
                        ...
                        <span className="absolute boost-text top-[495px] sm:top-[540px] mb-0 bg-blue-400 py-0 px-0 xxxs:px-[0.2px] sm:p-2 w-[315px] sm:w-[315px] chip">
                        ...
                        <div className="absolute flex items-center justify-center top-[547px] sm:top-[590px] w-full">
                            <div className="container flex flex-col items-center justify-center text-white align-middle w-100">
                                <div className="row flex justify-center text-center w-full h-12 gap-x-4 gap-y-3 xs:gap-y-0 max-w-[315px] xs:max-w-[800px] mt-2">
                                    <span className="hRaise col-sm bg-blue-500 rounded-[12px] hover:cursor-pointer content-center py-2 text-[17px] flex justify-center items-center"><a href='https://boost-hacks-ii.devpost.com/' target='_blank' className='flex format hover:cursor-pointer'>Register On Devpost</a></span>
                                    <span ref={widthRef} className="hRaise col-sm bg-blue-500 rounded-[12px] content-center py-2 flex items-center justify-center text-[17px]">
                                        <a href='https://discord.gg/FpgReGv4qp' target='_blank' className='flex format hover:cursor-pointer'>
                                            <span>Join Our</span>
                                            <FaDiscord id='width' color='white' className="ml-[4px] mt-[6px] spin" /></a>
                                    </span>
                                    <span className="hRaise col-sm bg-blue-500 rounded-[12px] content-center py-2 text-[17px] flex justify-center items-center"><a href='https://7y7w1tjdbbj.typeform.com/to/xgCXZ65q?typeform-source=boost-hacks-ii.devpost.com' target='_blank' className='flex format hover:cursor-pointer'>Be a Judge</a></span>
                                </div>
                            </div>
                        </div>
